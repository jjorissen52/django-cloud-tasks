# Generated by Django 3.0.6 on 2020-05-14 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('enabled', 'Running'), ('disabled', 'Paused'), ('unknown', 'Unknown'), ('broken', 'Broken')], default='enabled', help_text='Status of the clock. ', max_length=8)),
            ],
        ),
        migrations.CreateModel(
            name='Task',
