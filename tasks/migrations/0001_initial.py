    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True, help_text='Whether this clock is active. Does nothing if management is manual.', null=True)),
                ('management', models.CharField(choices=[('gcp', 'Cloud Scheduler'), ('manual', 'Manual')], default='auto', help_text='Whether to automatically or manually schedule in Cloud Scheduler', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='Task',
